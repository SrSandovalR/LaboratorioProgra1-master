    ...
    internal class VideoJuego
    {
        ...
        public double Calificacion
        {
            ...
            set
            {
                ...
                if (value >= 0 || value <= 10)// estaba al reves esta condicion
                {
                    calificacion = value;
                } else
                {
        ...
        public int AnioLanzamiento
        {
            ...
            set
            {
                ...
                if (anioLanzamiento <=2024) { // faltaba la condicion 
        ...
        public void TerminarJuego()
        {
            ...
            if (jugando) 
            {
                jugando = false; //faltaba la condicion para que terminara
       ...
       public static void listaDeJuegos() {
            Console.WriteLine("Leyenda de Zelda");
